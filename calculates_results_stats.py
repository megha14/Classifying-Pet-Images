...
def calculates_results_stats(results_dic):
    ...
    # this function 
    # Declare the results_stats_dic
    results_stats_dic = dict()
    
    # Set default values for all the keys
    ...
    #Loop over the results_dic to calculate stats
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            # Total count of correctly classified breeds
            if results_dic[key][3] == 1:
                results_stats_dic["n_correct_breed"] += 1
        
        # Total count of dog images
        if results_dic[key][3] == 1:
            results_stats_dic["n_dogs_img"] += 1
            
            # Total count of correctly classified dogs
        ...
        # Total count of not-a-dog images    
        ...
        # % Correctly classified not-a-dogs
