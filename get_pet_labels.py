...
def get_pet_labels(image_dir):
    ...
    #List to add pet names as labels
    pet_labels = []
    
    #Loop over filenames to create corresponding label and add the label to pet_labels
    for filename in filename_list:
        # Sets string to lower case letters and then splits into a list of words by _
        pet_name_in_file = filename.lower().split("_")
